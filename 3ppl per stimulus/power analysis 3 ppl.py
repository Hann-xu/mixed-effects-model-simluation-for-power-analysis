...
# Variance Components for Condition 2 vs. 3
    ...
    p = 9     # Number of participants per stimulus
...
df_vt_20stim_5part = pd.read_csv("3ppl_simulated_vt_20stim_5part.csv")
df_vt_30stim_5part = pd.read_csv("3ppl_simulated_vt_30stim_5part.csv")
...
compute_power_analysis_fixed(df_vt_20stim_5part, n_stimuli=20, n_participants_per_stimulus=3)
compute_power_analysis_fixed(df_vt_30stim_5part, n_stimuli=30, n_participants_per_stimulus=3)
