...
df_vt_5stim_8part = pd.read_csv("main code: 8ppl per stimulus/simulated_vt_5stim_8part.csv")
df_vt_10stim_8part = pd.read_csv("main code: 8ppl per stimulus/simulated_vt_10stim_8part.csv")
df_vt_20stim_8part = pd.read_csv("main code: 8ppl per stimulus/simulated_vt_20stim_8part.csv")
df_vt_30stim_8part = pd.read_csv("main code: 8ppl per stimulus/simulated_vt_30stim_8part.csv")
df_vt_40stim_8part = pd.read_csv("main code: 8ppl per stimulus/simulated_vt_40stim_8part.csv")
df_vt_50stim_8part = pd.read_csv("main code: 8ppl per stimulus/simulated_vt_50stim_8part.csv")
df_vt_60stim_8part = pd.read_csv("main code: 8ppl per stimulus/simulated_vt_60stim_8part.csv")
df_vt_70stim_8part = pd.read_csv("main code: 8ppl per stimulus/simulated_vt_70stim_8part.csv")
df_vt_80stim_8part = pd.read_csv("main code: 8ppl per stimulus/simulated_vt_80stim_8part.csv")
df_vt_90stim_8part = pd.read_csv("main code: 8ppl per stimulus/simulated_vt_90stim_8part.csv")
df_vt_100stim_8part = pd.read_csv("main code: 8ppl per stimulus/simulated_vt_100stim_8part.csv")
df_vt_110stim_8part = pd.read_csv("main code: 8ppl per stimulus/simulated_vt_110stim_8part.csv")
df_vt_120stim_8part = pd.read_csv("main code: 8ppl per stimulus/simulated_vt_120stim_8part.csv")
df_vt_130stim_8part = pd.read_csv("main code: 8ppl per stimulus/simulated_vt_130stim_8part.csv")


# Compute power analysis for each dataset (fixed version)
compute_power_analysis_fixed(df_vt_5stim_8part, n_stimuli=5, n_participants_per_stimulus=5)
compute_power_analysis_fixed(df_vt_10stim_8part, n_stimuli=10, n_participants_per_stimulus=5)
compute_power_analysis_fixed(df_vt_20stim_8part, n_stimuli=20, n_participants_per_stimulus=5)
compute_power_analysis_fixed(df_vt_30stim_8part, n_stimuli=30, n_participants_per_stimulus=5)
compute_power_analysis_fixed(df_vt_40stim_8part, n_stimuli=40, n_participants_per_stimulus=5)
compute_power_analysis_fixed(df_vt_50stim_8part, n_stimuli=50, n_participants_per_stimulus=5)
compute_power_analysis_fixed(df_vt_60stim_8part, n_stimuli=60, n_participants_per_stimulus=5)
compute_power_analysis_fixed(df_vt_70stim_8part, n_stimuli=70, n_participants_per_stimulus=5)
compute_power_analysis_fixed(df_vt_80stim_8part, n_stimuli=80, n_participants_per_stimulus=5)
compute_power_analysis_fixed(df_vt_90stim_8part, n_stimuli=90, n_participants_per_stimulus=5)
compute_power_analysis_fixed(df_vt_100stim_8part, n_stimuli=100, n_participants_per_stimulus=5)
compute_power_analysis_fixed(df_vt_110stim_8part, n_stimuli=110, n_participants_per_stimulus=5)
compute_power_analysis_fixed(df_vt_120stim_8part, n_stimuli=120, n_participants_per_stimulus=5)
compute_power_analysis_fixed(df_vt_130stim_8part, n_stimuli=130, n_participants_per_stimulus=5)
...
power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_5stim_8part, n_stimuli=5, n_participants_per_stimulus=5)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_10stim_8part, n_stimuli=10, n_participants_per_stimulus=5)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_20stim_8part, n_stimuli=20, n_participants_per_stimulus=5)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_30stim_8part, n_stimuli=30, n_participants_per_stimulus=5)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_40stim_8part, n_stimuli=40, n_participants_per_stimulus=5)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_50stim_8part, n_stimuli=50, n_participants_per_stimulus=5)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_60stim_8part, n_stimuli=60, n_participants_per_stimulus=5)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_70stim_8part, n_stimuli=70, n_participants_per_stimulus=5)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_80stim_8part, n_stimuli=80, n_participants_per_stimulus=5)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_90stim_8part, n_stimuli=90, n_participants_per_stimulus=5)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_100stim_8part, n_stimuli=100, n_participants_per_stimulus=5)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_110stim_8part, n_stimuli=110, n_participants_per_stimulus=5)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_120stim_8part, n_stimuli=120, n_participants_per_stimulus=5)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_130stim_8part, n_stimuli=130, n_participants_per_stimulus=5)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)
...
results_df.to_csv('power_analysis_results_8ppl.csv', index=False)
print("\nPower analysis results saved to power_analysis_results_8ppl.csv")
