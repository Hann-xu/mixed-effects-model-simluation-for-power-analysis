...
df_vt_5stim_1part = pd.read_csv("main code: 1ppl per stimulus/simulated_vt_5stim_1part.csv")
df_vt_10stim_1part = pd.read_csv("main code: 1ppl per stimulus/simulated_vt_10stim_1part.csv")
df_vt_20stim_1part = pd.read_csv("main code: 1ppl per stimulus/simulated_vt_20stim_1part.csv")
df_vt_30stim_1part = pd.read_csv("main code: 1ppl per stimulus/simulated_vt_30stim_1part.csv")
df_vt_40stim_1part = pd.read_csv("main code: 1ppl per stimulus/simulated_vt_40stim_1part.csv")
df_vt_50stim_1part = pd.read_csv("main code: 1ppl per stimulus/simulated_vt_50stim_1part.csv")
df_vt_60stim_1part = pd.read_csv("main code: 1ppl per stimulus/simulated_vt_60stim_1part.csv")
df_vt_70stim_1part = pd.read_csv("main code: 1ppl per stimulus/simulated_vt_70stim_1part.csv")
df_vt_80stim_1part = pd.read_csv("main code: 1ppl per stimulus/simulated_vt_80stim_1part.csv")
df_vt_90stim_1part = pd.read_csv("main code: 1ppl per stimulus/simulated_vt_90stim_1part.csv")
df_vt_100stim_1part = pd.read_csv("main code: 1ppl per stimulus/simulated_vt_100stim_1part.csv")
df_vt_110stim_1part = pd.read_csv("main code: 1ppl per stimulus/simulated_vt_110stim_1part.csv")
df_vt_120stim_1part = pd.read_csv("main code: 1ppl per stimulus/simulated_vt_120stim_1part.csv")
df_vt_130stim_1part = pd.read_csv("main code: 1ppl per stimulus/simulated_vt_130stim_1part.csv")

# Compute power analysis for each dataset (fixed version)
compute_power_analysis_fixed(df_vt_5stim_1part, n_stimuli=5, n_participants_per_stimulus=1)
compute_power_analysis_fixed(df_vt_10stim_1part, n_stimuli=10, n_participants_per_stimulus=1)
compute_power_analysis_fixed(df_vt_20stim_1part, n_stimuli=20, n_participants_per_stimulus=1)
compute_power_analysis_fixed(df_vt_30stim_1part, n_stimuli=30, n_participants_per_stimulus=1)
compute_power_analysis_fixed(df_vt_40stim_1part, n_stimuli=40, n_participants_per_stimulus=1)
compute_power_analysis_fixed(df_vt_50stim_1part, n_stimuli=50, n_participants_per_stimulus=1)
compute_power_analysis_fixed(df_vt_60stim_1part, n_stimuli=60, n_participants_per_stimulus=1)
compute_power_analysis_fixed(df_vt_70stim_1part, n_stimuli=70, n_participants_per_stimulus=1)
compute_power_analysis_fixed(df_vt_80stim_1part, n_stimuli=80, n_participants_per_stimulus=1)
compute_power_analysis_fixed(df_vt_90stim_1part, n_stimuli=90, n_participants_per_stimulus=1)
compute_power_analysis_fixed(df_vt_100stim_1part, n_stimuli=100, n_participants_per_stimulus=1)
compute_power_analysis_fixed(df_vt_110stim_1part, n_stimuli=110, n_participants_per_stimulus=1)
compute_power_analysis_fixed(df_vt_120stim_1part, n_stimuli=120, n_participants_per_stimulus=1)
compute_power_analysis_fixed(df_vt_130stim_1part, n_stimuli=130, n_participants_per_stimulus=1)
...
power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_5stim_1part, n_stimuli=5, n_participants_per_stimulus=1)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_10stim_1part, n_stimuli=10, n_participants_per_stimulus=1)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_20stim_1part, n_stimuli=20, n_participants_per_stimulus=1)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_30stim_1part, n_stimuli=30, n_participants_per_stimulus=1)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_40stim_1part, n_stimuli=40, n_participants_per_stimulus=1)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_50stim_1part, n_stimuli=50, n_participants_per_stimulus=1)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_60stim_1part, n_stimuli=60, n_participants_per_stimulus=1)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_70stim_1part, n_stimuli=70, n_participants_per_stimulus=1)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_80stim_1part, n_stimuli=80, n_participants_per_stimulus=1)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_90stim_1part, n_stimuli=90, n_participants_per_stimulus=1)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_100stim_1part, n_stimuli=100, n_participants_per_stimulus=1)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_110stim_1part, n_stimuli=110, n_participants_per_stimulus=1)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_120stim_1part, n_stimuli=120, n_participants_per_stimulus=1)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)

power_12, power_13, power_23 = compute_power_analysis_fixed(df_vt_130stim_1part, n_stimuli=130, n_participants_per_stimulus=1)
power_12_list.append(power_12)
power_13_list.append(power_13)
power_23_list.append(power_23)
...
results_df.to_csv('power_analysis_results_1ppl.csv', index=False)
print("\nPower analysis results saved to power_analysis_results_1ppl.csv")
