...
df_vt_5stim_5part = pd.read_csv("main code: 5ppl per stimulus/simulated_vt_5stim_5part.csv")
df_vt_10stim_5part = pd.read_csv("main code: 5ppl per stimulus/simulated_vt_10stim_5part.csv")
df_vt_20stim_5part = pd.read_csv("main code: 5ppl per stimulus/simulated_vt_20stim_5part.csv")
df_vt_30stim_5part = pd.read_csv("main code: 5ppl per stimulus/simulated_vt_30stim_5part.csv")
...
compute_power_analysis_fixed(df_vt_5stim_5part, n_stimuli=5, n_participants_per_stimulus=5)
compute_power_analysis_fixed(df_vt_10stim_5part, n_stimuli=10, n_participants_per_stimulus=5)
