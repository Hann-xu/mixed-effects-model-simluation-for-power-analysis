...
results_df = pd.read_csv('power_analysis_results.csv')
...
plt.title('5 participants per stimuli scenario', fontsize=16)
...
# Save the figure
plt.savefig('power_analysis_by_stimuli.png', dpi=300, bbox_inches='tight')
