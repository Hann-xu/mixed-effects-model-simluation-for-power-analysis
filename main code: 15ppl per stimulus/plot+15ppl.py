...
results_df = pd.read_csv('power_analysis_results_15ppl.csv')
...
plt.title('15 participants per stimuli scenario', fontsize=16)
...
# Save the figure
plt.savefig('power_analysis_by_stimuli_15ppl.png', dpi=300, bbox_inches='tight')
